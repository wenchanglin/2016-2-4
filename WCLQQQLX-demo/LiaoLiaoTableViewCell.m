...
@implementation LiaoLiaoTableViewCell
{
    CGRect _tmpRect;
...
#pragma mark - 判断图片个数
    if (_mArray.count==1) {
        ...
        [_shouChangBtn setImage:[self scaleToSize:shoucImg.image size:CGSizeMake(20, 20)] forState:UIControlStateNormal];
        ...
        [_commentBtn setImage:[self scaleToSize:liaoImg.image size:CGSizeMake(20, 20)] forState:UIControlStateNormal];
        [_commentBtn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 10)];
        
        _fenGeXian.frame = CGRectMake(0, CGRectGetMaxY(_shouChangBtn.frame)+15, [UIScreen mainScreen].bounds.size.width, 5);
        _fenGeXian.backgroundColor = [UIColor colorWithHexString:@"#f2f2f2"];
    }

...
- (void)showAlertController:(UIView *)view
{
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"quxiao", @"") style:UIAlertActionStyleCancel handler:^(UIAlertAction *action) {
        [self delegatePerformCancel];
    }]];
    alertController.popoverPresentationController.sourceView = self.currentVisibleController.view;
    alertController.popoverPresentationController.sourceRect = self.currentVisibleController.view.bounds;

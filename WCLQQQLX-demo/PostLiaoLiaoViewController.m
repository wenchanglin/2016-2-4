...
#import "Masonry.h"
@interface PostLiaoLiaoViewController ()<UITextViewDelegate, LocalImageViewControllerDelegate, UIScrollViewDelegate, UIAlertViewDelegate>
...
@implementation PostLiaoLiaoViewController
...
- (void)sendPostSuccess {
    ...
    [ProgressHUD showSuccess:NSLocalizedStringCN(@"fabiaochenggong", @"")];

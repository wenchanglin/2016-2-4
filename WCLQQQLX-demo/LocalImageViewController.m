...
- (void)initNavigationBar {
    self.navigationItem.title = NSLocalizedStringCN(@"tupianxuanze", @"");
}
...
//    浅绿色，完成按钮
    ...
    [_endBtn setTitle:NSLocalizedStringCN(@"wancheng", @"") forState:UIControlStateNormal];
    ...
    if (!flag)
    {
        ...
        if (selectCount >= _maxPhotoNumber) {
            UIAlertView*alert = [[UIAlertView alloc]initWithTitle:nil
                                                          message:[NSString stringWithFormat:NSLocalizedStringCN(@"zuiduoxuanze", @""), (long)_maxPhotoNumber]
                                                         delegate:nil
                                                cancelButtonTitle:NSLocalizedStringCN(@"wozhidaole", @"")
...
- (void)endBtnClick
{
    ...
    [ProgressHUD showError:NSLocalizedStringCN(@"zhengzaichulitupian", @"")];

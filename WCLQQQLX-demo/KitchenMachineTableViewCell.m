...
//    [_connectButton setTitle:@"连     接" forState:UIControlStateNormal];
    ...
    _connectButton.backgroundColor = [UIColor colorWithHexString:@"#FFCC33"];
...
- (void)setIsConnected:(BOOL)isConnected {
    if (isConnected) {
        [_connectButton setTitle:NSLocalizedStringCN(@"yilianjie", @"") forState:UIControlStateNormal];
    }
    else {
        [_connectButton setTitle:NSLocalizedStringCN(@"lianjie", @"") forState:UIControlStateNormal];
    }
}

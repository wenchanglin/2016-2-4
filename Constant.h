...
static NSString *kLinkURL = @"http://app-cn.greenis-service.com.cn/news/show-212.html";
static NSString *kLinkTagName = @"WECHAT_TAG_JUMP_SHOWRANK";
//static NSString *kLinkTitle = @"专访张小龙：产品之上的世界观";
static NSString *kLinkTitle = @"你的智能厨师";
static NSString *kLinkDescription = @"哇，果汁还能做得这么多姿多彩";
